...
using System.Linq;
using rec_rewild_classic.api.route;

namespace server
{
	internal class APIServer2019
	{
		public APIServer2019()
		{
			try
			{
				Console.WriteLine("[APIServer2019.cs] has started.");
        ...
        private void StartListen()
        {
            try
            {
                ...
                this.listener.Start();
                Console.WriteLine("[APIServer2019.cs] is listening.");
        ...
        private void HandleRequest(HttpListenerContext context)
        {
            try
            {
                ...
                s = avatar_route.avatar_route_data(Url, text, s);
